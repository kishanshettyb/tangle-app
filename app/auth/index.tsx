	...
	return (
		<SafeAreaView className="justify-start flex-1">
			<View className="flex items-center justify-center p-6">
				...
				<Text className="mb-4 text-4xl font-semibold text-center">Tangle! Redefining Social Connections</Text>
				...
				<TextInput className="w-full p-4 mb-4 border rounded-xl border-slate-400" placeholder="Enter email" onChangeText={(newText) => setText(newText)} defaultValue={text} />
				<View className="flex items-center justify-center w-full p-4 bg-slate-900 rounded-xl">
