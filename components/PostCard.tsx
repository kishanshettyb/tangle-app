...
const postData = [
  {
    ...
    description:
      "🐾 Beach Day Bliss 🌊]Nothing beats the pure joy of a dog running free on the beach! 🐕✨From splashing in the waves to chasing seagulls this pup is living their best life. 😍📍 Perfect day. Perfect vibes. Do you take your dog to the beach? Drop a 🐶 in the comments if you’re a dog lover! BeachDay DogAtTheBeach #PuppyLove #DogLife #DogsOfInstagram #OceanVibes",
    ...
    postAssets: [
      {
        id: 1,
        imageUrl:
          "https://i.ibb.co/5rrdcch/oscar-sutton-yihla-RCCvd4-unsplash.jpg",
      },
    ],
  },
  {
    ...
    postAssets: [
      {
        id: 1,
        videoUrl:
          "https://videos.pexels.com/video-files/25254351/11900288_1080_1920_30fps.mp4",
      },
    ],
  },
  {
